      ...
      <div style="z-index: 99999;" class="modal-content">
        ...
        <div class="modal-body form px-4">
          <form id="import_from_cp" class="modal-form pb-4">
            <?php
            printf('<input class="form-control" type="text" name="source_id" placeholder="%s" autocomplete="off" />', __('Search campaign', $this->plugin_name));
            ?>
            <div class="row mt-5">
              <div class="col-6 col-lg-4 offset-lg-2 text-right">
                <?php printf('<button type="submit" class="btn btn-primary">%s</button>', __('Import now', $this->plugin_name)); ?>
              </div>
